  ...
  if (error) {
    return (
      <div className="rounded-lg border border-red-200 bg-red-50 p-6 text-red-700">
        ...
        <p>
          Failed to load payment history. Please check your backend connection.
        </p>
      </div>
    );
  }
              ...
              {isLoading || isFetching ? (
                ...
                payments.map((pay) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      <span className="text-2xs inline-flex rounded-full bg-slate-100 px-2 py-0.5 font-bold text-slate-800">
                        {pay.plan}
                      </span>
                    </td>
                    ...
                    <td className="px-6 py-4">
                      <span
                        className={`text-2xs inline-flex rounded-full px-2.5 py-0.5 font-bold ${
                          pay.status === "SUCCESS"
